...
public class IPCTracingAndMetricsAwareFireAndForgetFunction implements IPCFunction<Mono<Void>> {
    ...
    public IPCTracingAndMetricsAwareFireAndForgetFunction(String route, Unmarshaller unmarshaller, Marshaller marshaller, Functions.FireAndForget fnf, Tracer tracer, MeterRegistry meterRegistry) {
        this.route = route;
