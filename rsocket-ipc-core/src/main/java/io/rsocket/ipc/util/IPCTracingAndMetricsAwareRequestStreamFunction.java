...
public class IPCTracingAndMetricsAwareRequestStreamFunction implements IPCFunction<Flux<Payload>> {
    ...
    public IPCTracingAndMetricsAwareRequestStreamFunction(String route, Unmarshaller unmarshaller, Marshaller marshaller, Functions.RequestStream rs, Tracer tracer, MeterRegistry meterRegistry) {
        this.route = route;
