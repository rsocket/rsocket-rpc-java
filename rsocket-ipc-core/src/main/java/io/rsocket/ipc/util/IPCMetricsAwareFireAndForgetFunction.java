...
public class IPCMetricsAwareFireAndForgetFunction implements IPCFunction<Mono<Void>> {
    ...
    public IPCMetricsAwareFireAndForgetFunction(String route, Unmarshaller unmarshaller, Marshaller marshaller, Functions.FireAndForget fnf, MeterRegistry meterRegistry) {
        this.route = route;
